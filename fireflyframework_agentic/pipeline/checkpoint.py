...
The framework ships :class:`FileCheckpointer` for dev / single-host work.
For Postgres- or Redis-backed checkpointing, see the plug-and-play templates
under ``examples/software_factory/checkpointers/``: each is a ~50 LOC class
that implements the :class:`Checkpointer` Protocol against a caller-supplied
connection. Copy whichever you need into your project and adapt.
"""
